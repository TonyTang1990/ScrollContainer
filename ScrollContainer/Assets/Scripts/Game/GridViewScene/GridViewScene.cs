...
/// <summary>
/// GridViewScene Scripts
/// </summary>
public class GridViewScene : MonoBehaviour
{
    /// <summary>
    /// BackToMainMenu
    /// </summary>
    ...
    /// </summary>
    [Header("横向从左往右单元格容器")]
    public HorizontalGridScrollContainer GridViewContainer;

    void Start()
    {
        BtnBackToMainMenu.onClick.AddListener(onBtnBackToMainMenu);
        GridViewContainer.bindContainerCallBack(onCellShow);
        GridViewContainer.setCellDatasByCellCount(20);
    }
